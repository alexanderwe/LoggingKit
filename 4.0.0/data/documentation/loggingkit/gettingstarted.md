<!--
{
  ...
  "identifier" : "/documentation/LoggingKit/GettingStarted",
...
Extend [`LogCategories`](/documentation/LoggingKit/LogCategories) to declare the log categories for your app:
...
Register one or more [`LogProvider`](/documentation/LoggingKit/LogProvider) instances at app startup. LoggingKit ships with [`OSLogProvider`](/documentation/LoggingKit/OSLogProvider) out of the box:
...
Use [`LogService`](/documentation/LoggingKit/LogService) to emit categorized log messages:
...
Conform to [`LogProvider`](/documentation/LoggingKit/LogProvider) to route logs to any backend (e.g. Crashlytics, a remote logging service):
